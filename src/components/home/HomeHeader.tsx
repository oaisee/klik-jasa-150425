...
const HomeHeader = ({
  ...
  return <div className="bg-gradient-to-r from-green-500 to-blue-600 fixed top-0 left-0 right-0 z-10 px-4 py-3 flex justify-between items-center text-white">
      <div className="flex items-center">
        <img alt="KlikJasa" className="h-8 mr-2" onError={e => {
        e.currentTarget.onerror = null;
        e.currentTarget.src = "/placeholder.svg";
      }} src="/lovable-uploads/f7574d2b-08d2-4cb8-b3e5-aa1126978bec.png" />
